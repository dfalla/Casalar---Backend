...
router.get('/:id', controllers_1.getMotoguadana);
router.post('/', validarCamposProducto_1.validarProducto, controllers_1.createMotoguadana);
router.put('/:id', validarCamposProducto_1.validarProducto, controllers_1.updateMotoguadana);
router.delete('/:id', controllers_1.deleteMotoguadana);
