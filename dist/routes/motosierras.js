...
router.get('/:id', controllers_1.getMotosierra);
router.post('/', validarCamposProducto_1.validarProducto, controllers_1.createMotosierra);
router.put('/:id', validarCamposProducto_1.validarProducto, controllers_1.updateMotosierra);
router.delete('/:id', controllers_1.deleteMotosierra);
