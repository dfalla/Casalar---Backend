...
router.get('/:id', controllers_1.getAceite);
router.post('/', validarCamposProducto_1.validarProducto, controllers_1.createAceite);
router.put('/:id', validarCamposProducto_1.validarProducto, controllers_1.updateAceite);
router.delete('/:id', controllers_1.deleteAceite);
