...
exports.validarCamposRegistro = [
    ...
    (0, validationResult_1.check)('password', 'El password debe de ser de 15 caracteres como máximo').isLength({ max: 15 }),
    validationResult_1.validarCampos
];
exports.validarCamposLogin = [
    (0, validationResult_1.check)('username', 'El email es obligatorio').not().isEmpty(),
