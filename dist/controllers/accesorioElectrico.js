...
exports.deleteAccesorioElectrico = exports.updateAccesorioElectrico = exports.createAccesorioElectrico = exports.getAccesorioElectrico = exports.getAccesoriosElectricos = void 0;
...
exports.getAccesoriosElectricos = getAccesoriosElectricos;
const getAccesorioElectrico = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const producto = yield models_1.AccesorioElectrico.findByPk(id);
        if (!producto) {
...
exports.getAccesorioElectrico = getAccesorioElectrico;
const createAccesorioElectrico = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let image_public_id;
        try {
            const existeProducto = yield models_1.AccesorioElectrico.findOne({
                where: {
                    marca: marca
                }
            });
...
exports.updateAccesorioElectrico = updateAccesorioElectrico;
const deleteAccesorioElectrico = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const producto = yield models_1.AccesorioElectrico.findByPk(id);
        if (!producto) {
...
exports.deleteAccesorioElectrico = deleteAccesorioElectrico;
